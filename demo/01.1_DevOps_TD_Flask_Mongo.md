...
3. Créez un fichier vide nommé `__init__.py` ( ce dernier servira de pointeur à Python pour lire trouver ce fichier)
...
TODO
Création de la BDD et de la collection
...
Modifions notre code pour récupérer ces informations et les utiliser pour se connecter à la BDD MongoDB dans `main_routes.py`
